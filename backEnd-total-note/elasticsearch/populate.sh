...
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together" -d@$(dirname $0)/mapping.json
...
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/group/1" -d'{
  "name": "Denver Clojure",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/group/2" -d'{
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/group/3" -d'{
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/group/4" -d'{
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/group/5" -d'{
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/101?parent=1" -d'{
  "host": "Sean",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/102?parent=1" -d'{
  "host": "Daniel",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/103?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/104?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/105?parent=2" -d'{
  "host": "Lee",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/106?parent=3" -d'{
  "host": "Mik",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/107?parent=3" -d'{
  "host": "Mik",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/108?parent=3" -d'{
  "host": "Elyse",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/109?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/110?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/111?parent=4" -d'{
  "host": "Andy",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/112?parent=5" -d'{
  "host": "Dave Nolan",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/113?parent=5" -d'{
  "host": "Dave",
...
echo
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/event/114?parent=5" -d'{
  "host": "Yann",
...
curl -s -XPOST -H "Content-Type: application/json" "$ADDRESS/get-together/_refresh"
...
curl -s -XPOST -H "Content-Type: application/json" "http://$ADDRESS/november_2014_invoices" -d'{}'
echo
curl -s -XPOST -H "Content-Type: application/json" "http://$ADDRESS/december_2014_invoices" -d'
{
    "mappings" :
    {
        "invoice" :
...
curl -s -XPOST -H "Content-Type: application/json" "http://$ADDRESS/_aliases" -d'
{
    "actions" : [
	{
		"add" :
